 ...
 * @since 2.13
 */
public class SummariserRunningSample2 {
     ...
     */
    public SummariserRunningSample2(String label) {
        this.label = label;
        init();
    }
     ...
     */
    public SummariserRunningSample2(SummariserRunningSample2 src) {
        label = src.label;
        counter = src.counter;
     ...
     */
    public void addSample(SummariserRunningSample2 rs) {
        counter += rs.counter;
