 ...
 * Note that the {@link SummariserRunningSample2} start and end times relate to the samples,
 ...
 *
 */
public class Summariser2 extends AbstractTestElement
     ...
     */
    public Summariser2(String name) {
        this();
        setName(name);
    }
    ...
    private static class Totals {
        ...
        private final SummariserRunningSample2 delta = new SummariserRunningSample2("DELTA");

        private final SummariserRunningSample2 total = new SummariserRunningSample2("TOTAL");
    ...
    public void sampleOccurred(SampleEvent e) {
        ...
        SummariserRunningSample2 myDelta = null;
        SummariserRunningSample2 myTotal = null;
        ...
        synchronized (myTotals) {
            ...
            if ((now > myTotals.last + INTERVAL_WINDOW) && (now % INTERVAL <= INTERVAL_WINDOW)) {
                ...
                myDelta = new SummariserRunningSample2(myTotals.delta);
                myTotals.moveDelta();
                myTotal = new SummariserRunningSample2(myTotals.total);
     ...
     * @param summariserRunningSample {@link SummariserRunningSample2}
     * @param type Type of summariser (difference or total)
     * @return the summary information
     */
    private static String format(String name, SummariserRunningSample2 summariserRunningSample, String type) {
