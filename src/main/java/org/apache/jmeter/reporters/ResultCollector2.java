 ...
 */
public class ResultCollector2 extends AbstractListenerElement implements SampleListener, Clearable, Serializable,
    ...
    private volatile Summariser2 summariser;

    /**
     * No-arg constructor.
     */
    public ResultCollector2() {
        this(null);
    }
     ...
     */
    public ResultCollector2(Summariser2 summer) {
    ...
    @Override
    public Object clone(){
        ResultCollector2 clone = (ResultCollector2) super.clone();
    ...
    private static void finalizeFileOutput() {
        for(Map.Entry<String, ResultCollector2.FileEntry> me : files.entrySet()) {
            String key = me.getKey();
            ResultCollector2.FileEntry value = me.getValue();
            try {
